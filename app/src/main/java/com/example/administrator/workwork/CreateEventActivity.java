...
import com.example.administrator.workwork.fragment.CreateventFragment;
...
public class CreateEventActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedStorage = new StorageSharedPref(CreateEventActivity.this);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                Intent intentE = new Intent(CreateEventActivity.this, EventActivity.class);
...
//                break;
    ...
    private void onLogoutButtonClicked() {
        ...
        Intent intent=new Intent(CreateEventActivity.this,SignIn.class);
