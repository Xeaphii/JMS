...
public class CreateOfferFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_createoffer, container, false);


        Intent intent=getActivity().getIntent();
        sharedStorage = new StorageSharedPref(CreateOfferFragment.this.getActivity());
            ...
            public void onClick(View v) {
                ...
                if (!(eventID ==null)){
                    ...
                    if (isNetworkAvailable()) {
                        new CreateEventJob(CreateOfferFragment.this.getActivity()).execute(new String[]{
                                name_str,
                                start_time_str,
                                end_time_str,
                                event_type,
