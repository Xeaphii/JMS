...
import com.example.administrator.workwork.fragment.DetailsFragment;
...
public class DetailsEventActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedStorage = new StorageSharedPref(DetailsEventActivity.this);
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            Intent intent=new Intent(DetailsEventActivity.this,ProfileActivity.class);
                ...
                break;
            case 2:
                Intent intentE = new Intent(DetailsEventActivity.this, EventActivity.class);
...
//                break;
    ...
    private void onLogoutButtonClicked() {
       ...
       LoginManager.getInstance().logOut();
        ...
        Intent intent=new Intent(DetailsEventActivity.this,SignIn.class);
