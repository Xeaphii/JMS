...
public class Signup extends Activity {
    ...
    class SignUpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... urls) {
            ...
            try {
                    //------------------>>
                    HttpGet httppost = new HttpGet(("http://xeamphiil.co.nf/JMS/signup.php?proj_username=" +
                            encodeHTML(urls[0]) +
                            "&proj_password=" +
                            encodeHTML(urls[1]) +
                            "&proj_email=" +
...
//                Toast.makeText(context,"User Created Successfullly",Toast.LENGTH_LONG).show();
    ...
    Boolean IsUerNameValid(String userName){
        try {
            ...
            //------------------>>
            HttpGet httppost = new HttpGet(("http://xeamphiil.co.nf/JMS/userNameCheck.php?proj_username=" +
